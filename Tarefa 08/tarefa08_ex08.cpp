// 8. Escreva uma função com protótipo void somabit (int b1, int b2, int *vaium, int *soma); que recebe três bits 
//(inteiros entre 0 e 1) b1, b2 e *vaium e devolve um bit soma representando a soma dos três e o novo um bit "vai-um" em *vaium. 
